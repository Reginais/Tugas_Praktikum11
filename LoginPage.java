    ...
    public LoginPage(MainFrame frame) {
       setLayout(null);
        ...
        btnLogin.addActionListener(e -> {
            ...
            }else if (username.equals("user") && password.equals("user12345")) {
                frame.setAdmin(false);
                frame.showPage("home");
            } else {
                JOptionPane.showMessageDialog(this, "Username atau Password salah dik");
                lblMsg.setText("Username atau Password salah dik");
            }
        });
    }
