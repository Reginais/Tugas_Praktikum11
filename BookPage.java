...
//        btnDelete.setEnabled(frame.isAdmin());
        ...
        btnAdd.addActionListener(e -> {
            ...
            if (result == JOptionPane.OK_OPTION) {
                try {
                    Book newBook = new Book(judul.getText(), penulis.getText(),
                            Integer.parseInt(tahun.getText()), false);
        ...
        btnEdit.addActionListener(e -> {
            ...
            if (row >= 0) {
                ...
                int result = JOptionPane.showConfirmDialog(this, input, "Edit Buku",
                        JOptionPane.OK_CANCEL_OPTION);
                if (result == JOptionPane.OK_OPTION) {
                    try {
                ...
                JOptionPane.showMessageDialog(this, "Pilih data dulu dik");
            }
        });
        ...
        btnDelete.addActionListener(e -> {
            ...
            if (row >= 0) {
                int confirm = JOptionPane.showConfirmDialog(this,
                        "Beneran nih mau di hapus?",
                        "Iya Hapus", JOptionPane.YES_NO_OPTION);
